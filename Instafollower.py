...
canvas = Canvas(root, width=160, height=180)
...
Entry(root, textvariable=en1, font="lucica 11 bold").place(x=300, y=220)
Entry(root, textvariable=en2, font="lucica 11 bold", show="*").place(x=300, y=260)
Button(root, command=get_value, text='Log In').place(x=300, y=300)
root.mainloop()
